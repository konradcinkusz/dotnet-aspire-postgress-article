...
<!-- src/Game.AppHost/Game.AppHost.csproj -->
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <PropertyGroup>
    ...
    <UserSecretsId>game-apphost-secrets</UserSecretsId>
  </PropertyGroup>
  ...
  <ItemGroup>
    <ProjectReference Include="..\Game.Web\Game.Web.csproj" />
  </ItemGroup>
</Project>
\end{lstlisting}
...
This flag enables the code-generation step that produces the \texttt{Projects.Game\_Web} type reference used in \texttt{Program.cs}.
...
\begin{lstlisting}
dotnet sln Game.sln add src/Game.AppHost/Game.AppHost.csproj
\end{lstlisting}
...
the run configuration dropdown should point at \texttt{Game.AppHost}.
